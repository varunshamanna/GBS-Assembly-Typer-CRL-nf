process res_typer {
    ...
    """
    process_res_typer_results.py --srst2_gbs_fullgenes ${RES_fullgenes} --srst2_gbs_consensus ${RES_consensus} --srst2_other_fullgenes ${arg_fullgenes} ${resfinder_fullgenes} --output_prefix ${pair_id}
    """
}
