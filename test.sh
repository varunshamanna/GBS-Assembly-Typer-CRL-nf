...
nextflow run main.nf --reads "$in_dir/test_{1,2}.fastq.gz" --output "$out_dir/test"
...
file_diff ${out_dir}/test_drug_cat_alleles.txt ${out_dir}/reference_drug_cat_alleles.txt
error_status=$?
